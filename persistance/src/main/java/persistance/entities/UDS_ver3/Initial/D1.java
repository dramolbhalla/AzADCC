...
public class D1 implements Serializable {
	...
	public D1(int d1, int dxmethod, int normcog, int demented, int amndem,
			...
			int meds, int medsif, int cogoth, int cogothif, String cogothx,
			int cogoth2, int cogoth2f, String cogoth2x, int cogoth3,
			int cogoth3f, String cogoth3x) {
		super();
		this.d1 = d1;
	...
	public int getCogoth() {
		return cogoth;
	}
	public void setCogoth(int cogoth) {
		this.cogoth = cogoth;
	}
	public int getCogothif() {
		return cogothif;
	}
	public void setCogothif(int cogothif) {
		this.cogothif = cogothif;
	}
	...
	public int getCogoth2() {
		return cogoth2;
	}
	public void setCogoth2(int cogoth2) {
		this.cogoth2 = cogoth2;
	}
	public int getCogoth2f() {
		return cogoth2f;
	}
	public void setCogoth2f(int cogoth2f) {
		this.cogoth2f = cogoth2f;
	}
	...
	public int getCogoth3() {
		return cogoth3;
	}
	public void setCogoth3(int cogoth3) {
		this.cogoth3 = cogoth3;
	}
	public int getCogoth3f() {
		return cogoth3f;
	}
	public void setCogoth3f(int cogoth3f) {
		this.cogoth3f = cogoth3f;
	}
