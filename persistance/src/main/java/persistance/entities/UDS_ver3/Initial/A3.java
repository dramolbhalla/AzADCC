...
public class A3 implements Serializable {
	...
	public A3(int a3, int afffamm, int fadmut, String fadmutx, int fadmuso,
			...
			int sibs, int sib1mob, int sib1yob, int sib1agd, int sib1neu,
			...
			int kid1mob, int kid1yob, int kid1agd, int kid1neu, int kid1pdx,
			int kid1moe, int kid1ago, int kid2mob, int kid2yob, int kid2agd,
			int kid2neu, int kid2pdx, int kid2moe, int kid2ago, int kid3mob,
			int kid3yob, int kid3agd, int kid3neu, int kid3pdx, int kid3moe,
			int kid3ago, int kid4mob, int kid4yob, int kid4agd, int kid4neu,
			int kid4pdx, int kid4moe, int kid4ago, int kid5mob, int kid5yob,
			int kid5agd, int kid5neu, int kid5pdx, int kid5moe, int kid5ago,
			int kid6mob, int kid6yob, int kid6agd, int kid6neu, int kid6pdx,
			int kid6moe, int kid6ago, int kid7mob, int kid7yob, int kid7agd,
			int kid7neu, int kid7pdx, int kid7moe, int kid7ago, int kid8mob,
			int kid8yob, int kid8agd, int kid8neu, int kid8pdx, int kid8moe,
			int kid8ago, int kid9mob, int kid9yob, int kid9agd, int kid9neu,
			int kid9pdx, int kid9moe, int kid9ago, int kid10mob, int kid10yob,
			int kid10agd, int kid10neu, int kid10pdx, int kid10moe,
			int kid10ago, int kid11mob, int kid11yob, int kid11agd,
			int kid11neu, int kid11pdx, int kid11moe, int kid11ago,
			int kid12mob, int kid12yob, int kid12agd, int kid12neu,
			int kid12pdx, int kid12moe, int kid12ago, int kid13mob,
			int kid13yob, int kid13agd, int kid13neu, int kid13pdx,
			int kid13moe, int kid13ago, int kid14mob, int kid14yob,
			int kid14agd, int kid14neu, int kid14pdx, int kid14moe,
			int kid14ago, int kid15mob, int kid15yob, int kid15agd,
			int kid15neu, int kid15pdx, int kid15moe, int kid15ago) {
		super();
		this.a3 = a3;
	...
	public A3(User user, Subject subject, Header header, int a3, int afffamm,
			...
			int sib1mob, int sib1yob, int sib1agd, int sib1neu, int sib1pdx,
			int sib1moe, int sib1ago, int sib2mob, int sib2yob, int sib2agd,
			int sib2neu, int sib2pdx, int sib2moe, int sib2ago, int sib3mob,
			int sib3yob, int sib3agd, int sib3neu, int sib3pdx, int sib3moe,
			int sib3ago, int sib4mob, int sib4yob, int sib4agd, int sib4neu,
			int sib4pdx, int sib4moe, int sib4ago, int sib5mob, int sib5yob,
			int sib5agd, int sib5neu, int sib5pdx, int sib5moe, int sib5ago,
			int sib6mob, int sib6yob, int sib6agd, int sib6neu, int sib6pdx,
			int sib6moe, int sib6ago, int sib7mob, int sib7yob, int sib7agd,
			int sib7neu, int sib7pdx, int sib7moe, int sib7ago, int sib8mob,
			int sib8yob, int sib8agd, int sib8neu, int sib8pdx, int sib8moe,
			int sib8ago, int sib9mob, int sib9yob, int sib9agd, int sib9neu,
			int sib9pdx, int sib9moe, int sib9ago, int sib10mob, int sib10yob,
			int sib10agd, int sib10neu, int sib10pdx, int sib10moe,
			int sib10ago, int sib11mob, int sib11yob, int sib11agd,
			int sib11neu, int sib11pdx, int sib11moe, int sib11ago,
			int sib12mob, int sib12yob, int sib12agd, int sib12neu,
			int sib12pdx, int sib12moe, int sib12ago, int sib13mob,
			int sib13yob, int sib13agd, int sib13neu, int sib13pdx,
			int sib13moe, int sib13ago, int sib14mob, int sib14yob,
			int sib14agd, int sib14neu, int sib14pdx, int sib14moe,
			int sib14ago, int sib15mob, int sib15yob, int sib15agd,
			int sib15neu, int sib15pdx, int sib15moe, int sib15ago,
			int sib16mob, int sib16yob, int sib16agd, int sib16neu,
			int sib16pdx, int sib16moe, int sib16ago, int sib17mob,
			int sib17yob, int sib17agd, int sib17neu, int sib17pdx,
			int sib17moe, int sib17ago, int sib18mob, int sib18yob,
			int sib18agd, int sib18neu, int sib18pdx, int sib18moe,
			int sib18ago, int sib19mob, int sib19yob, int sib19agd,
			int sib19neu, int sib19pdx, int sib19moe, int sib19ago,
			int sib20mob, int sib20yob, int sib20agd, int sib20neu,
			int sib20pdx, int sib20moe, int sib20ago, int kids, int kid1mob,
			int kid1yob, int kid1agd, int kid1neu, int kid1pdx, int kid1moe,
			int kid1ago, int kid2mob, int kid2yob, int kid2agd, int kid2neu,
			int kid2pdx, int kid2moe, int kid2ago, int kid3mob, int kid3yob,
			int kid3agd, int kid3neu, int kid3pdx, int kid3moe, int kid3ago,
			int kid4mob, int kid4yob, int kid4agd, int kid4neu, int kid4pdx,
			int kid4moe, int kid4ago, int kid5mob, int kid5yob, int kid5agd,
			int kid5neu, int kid5pdx, int kid5moe, int kid5ago, int kid6mob,
			int kid6yob, int kid6agd, int kid6neu, int kid6pdx, int kid6moe,
			int kid6ago, int kid7mob, int kid7yob, int kid7agd, int kid7neu,
			int kid7pdx, int kid7moe, int kid7ago, int kid8mob, int kid8yob,
			int kid8agd, int kid8neu, int kid8pdx, int kid8moe, int kid8ago,
			int kid9mob, int kid9yob, int kid9agd, int kid9neu, int kid9pdx,
			int kid9moe, int kid9ago, int kid10mob, int kid10yob, int kid10agd,
	...
	public int getAfffamm() {
		return afffamm;
	}
	public void setAfffamm(int afffamm) {
		this.afffamm = afffamm;
	}
